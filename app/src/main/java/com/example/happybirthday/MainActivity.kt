        ...
        setContent {
            HappyBirthdayTheme {
                Surface(modifier = Modifier.fillMaxSize(),color = MaterialTheme.colorScheme.background) {
                    GreetingText(message = "Happy Birthday Aca!", from = "From Willy", modifier = Modifier.padding(8.dp))
                }
            }
        }
    }
...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier) {
    ...
    Box(modifier) {
        Image(
            ...
            contentScale = ContentScale.Crop, alpha = 2F
        )
        GreetingText(
            message = message,
            from = from,
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        GreetingImage(message = "Happy Birthday Aca!", from = "From: Willy")
    }
}